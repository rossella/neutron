...
class OVSNeutronAgent(sg_rpc.SecurityGroupAgentRpcCallbackMixin,
    ...
    def process_ports_events(self, events, registered_ports, ancillary_ports,
        ...
        ancillary_port_info['current'] = (
            ancillary_ports - failed_ancillary_devices.get('added') if ancillary_ports else set())
    ...
    def treat_devices_added_or_updated(self, devices, failed_devices, ovs_restarted):
        skipped_devices = []
        ...
        while self.run_daemon_loop:
            ...
            if self._agent_has_updates(polling_manager) or sync:
                try:
                    ...
                    if self.ancillary_brs:
                        failed_ancillary_devices = self.process_ancillary_network_ports(
                            ancillary_port_info)
