...
class OVSNeutronAgent(sg_rpc.SecurityGroupAgentRpcCallbackMixin,
    ...
    def __init__(self, bridge_classes, integ_br, tun_br, local_ip,
        ...
        :param quitting_rpc_timeout: timeout in seconds for rpc calls after
               SIGTERM is received
        :param conf: an instance of cfg.CONF
        '''
    ...
    def reset_tunnel_br(self, tun_br_name=None):
        ...
        self.patch_tun_ofport = self.int_br.add_patch_port(
            self.conf.OVS.int_peer_patch_port, self.conf.OVS.tun_peer_patch_port)
        self.patch_int_ofport = self.tun_br.add_patch_port(
            self.conf.OVS.tun_peer_patch_port, self.conf.OVS.int_peer_patch_port)
